...
<header class="main bg-dark-img home-1">
    <div class="container">
        ...
        <div class="screens animation-domready">
            <p>
                <img src="${request.contextPath}/img/home1_tab3.png" data-animation-delay="0.5s" data-animation="fadeInUp" class="animated" alt="" />
                <img src="${request.contextPath}/img/home1_tab2.png" data-animation-delay="1.5s" data-animation="fadeInUp" class="animated" alt="" />
                <img src="${request.contextPath}/img/home1_tab1.png" data-animation-delay="2.5s" data-animation="fadeInUp" class="animated" alt="" />
            </p>
        </div>
    </div>
</header>
...
<div class="container content content-light home-1">
    <section class="row animation-scroll">
        <figure class="col-md-6 animated" data-animation="bounceInLeft"><img src="${request.contextPath}/img/home1_img1.png" alt="" /></figure>
    ...
    <section class="row animation-scroll">
        ...
        <figure class="col-md-6 animated" data-animation="bounceInRight"><img src="${request.contextPath}/img/home1_img2.png" alt="" /></figure>
    </section>
    <section class="row animation-scroll">
        <figure class="col-md-6 animated" data-animation="bounceInLeft"><img src="i${request.contextPath}/mg/home1_img3.png" alt="" /></figure>
        <article class="col-md-6 animated" data-animation="bounceInRight">
