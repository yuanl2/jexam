                ...
                <div class="navbar-right menu-main">
                    <ul class="nav navbar-nav">
                        ...
                        <#else>
                            ...
                            <li><a class="btn" href="${request.contextPath}/register">注册</a></li>
                        </#if>
                    </ul>
                </div>
            </div>
            ...
            <div class="test col-md-9">
                ...
                <ul class="">
                    <li class="course-nav-item on">
                        <a href="${request.contextPath}/exercises/list?type=all">全部</a>
                    </li>
                    <#list subjects as item>
                    <li class="course-nav-item">
                        <a href="${request.contextPath}/exercises/list?type=${(item.id)!}" >${(item.name)!}</a>
                    </li>
                    </#list>
                </ul>
            </div>
        ...
        <div class="row">
            <div class="test col-md-9">
                ...
                <ul class="">
                    ...
                    <li class="course-nav-item">
                        <a href="${request.contextPath}/exercises/list?type=single_choose" >单择题</a>
                    </li>
                    <li class="course-nav-item">
                        <a href="${request.contextPath}/exercises/list?type=multi_choose" >选择题</a>
                    </li>
                    <li class="course-nav-item">
                        <a href="${request.contextPath}/exercises/list?type=completion" >填空题</a>
                    </li>
                    <li class="course-nav-item">
                        <a href="${request.contextPath}/exercises/list?type=short_answer" >简答题</a>
                    </li>
                </ul>
            </div>
        </div>
...
<div class="container content content-light">
   <#--     <div class="filter">
                     ...
                     <div class="form-group">
                         <div class="panel panel-info">
                             ...
                             <div class="panel-body">
                                 ...
                                 <p>
                                     <a class="btn btn-info" style="color:white" href="${request.contextPath}/user/stu/collect_exercises/add/${item.id!}">收藏</a>
                                 </p>
                             </div>
                         </div>
                     </div>
        ...
        <ul class="pagination">
        <#if (currentPage > 1)>
            <li><a href="${request.contextPath}/exercises/list?type=${exerciseType!"all"}&page=${currentPage - 1}"><i class="fa fa-angle-left"></i></a></li>
        <#else>
            <li class="disabled"><a href="${request.contextPath}/exercises/list?type=${exerciseType!"all"}&page=${currentPage - 1}"><i class="fa fa-angle-left"></i></a></li>
        </#if>
        <#list 1..count as t>
            <#if currentPage == t>
                <li class="active"><a href="${request.contextPath}/exercises/list?type=${exerciseType!"all"}&page=${t - 1}">${t}</a></li>
            <#else>
                <li><a href="${request.contextPath}/exercises/list?type=${exerciseType!"all"}&page=${t - 1}"></a></li>
            </#if>
        </#list>
        <#if (currentPage < count)>
            <li><a href="${request.contextPath}/exercises/list?type=${exerciseType!"all"}&page=${currentPage + 1}"><i class="fa fa-angle-right"></i></a></li>
        <#else>
            <li class="disabled"><a href="${request.contextPath}/exercises/list?type=${exerciseType!"all"}&page=${currentPage + 1}"><i class="fa fa-angle-right"></i></a></li>
        </#if>
        </ul>
    </div>
