    ...
    <nav class="navbar navbar-inverse navbar-fixed-top navbar-bg" role="navigation">
        ...
        <div class="collapse navbar-collapse navbar-ex1-collapse">
            <ul class="nav navbar-nav side-nav">
                ...
                <li class="active-bg"><a href="${request.contextPath}/user/tea/add_student"><i class="fa fa-plus"></i> 添加学生</a></li>
    ...
    <div id="page-wrapper">
        <div class="row">
            <div class="col-lg-12">
                ...
                <br>
                <br>
                <form role="form" name="course" action="${request.contextPath}/user/tea/students" method="post">
